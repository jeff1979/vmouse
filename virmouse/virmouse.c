                              ...
                              const char *buffer, size_t count)
{
		...
		#else
		input_report_key(virmouse_input_dev, BTN_LEFT, key&0x1);
        input_report_key(virmouse_input_dev, BTN_MIDDLE, key&0x2);
        input_report_key(virmouse_input_dev, BTN_RIGHT, key&0x4);
		#endif
